...
const InfoBlock = ({classToUse, ID, index, Country, TotalDeaths, TotalRecovered, TotalConfirmed}) => {
    ...
    return (
        ...
        <div className={classToUse} id={ID} onClick={() => setIsOpen(true)}>
            <div>{index}</div>
            <div>{Country}</div>
